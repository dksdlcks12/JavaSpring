...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/recallApply.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/recallViewList.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/recallView.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/adminRecallView.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/asApply.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/asViewList.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/asView.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/noticeList.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/noticeWrite.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/noticeView.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/reviewWriteList.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/goodsSearch.css">
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/goodsSearch.js"></script>
