       	...
       	<div class="user-set-header-menuBox">
			...
			<ul class="user-set-bottomMenuBox" >
				...
				<ul class="user-set-listEarRing">귀걸이종류
					<a href="<%=request.getContextPath()%>/goodslist?type=3&page=1" class="user-set-goEarClip">귀  찌</a>
					<a href="<%=request.getContextPath()%>/goodslist?type=4&page=1" class="user-set-goEarRing">귀걸이</a>
				</ul>
